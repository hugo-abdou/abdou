...
<template>
    <template v-if="!isLessThanOverlayNavBreakpoint(windowWidth)">
        ...
        <VNavigationDrawer v-model="isNavDrawerOpen" temporary location="end" width="400" :scrim="false" class="app-customizer">
            <!-- 👉 Header -->
            ...
            <PerfectScrollbar tag="ul" :options="{ wheelPropagation: false }">
                ...
                <CustomizerSection title="THEMING" :divider="false">
                    ...
                    <div class="d-flex align-center">
                        ...
                        <div>
                            <VSwitch id="pricing-plan-toggle" v-model="theme" label="Dark" true-value="dark" false-value="light" />
                        </div>
                    </div>
                ...
                <CustomizerSection title="MENU">
                    ...
                    <!-- 👉 Collapsed Menu -->
                    <div v-if="appContentLayoutNav === AppContentLayoutNav.Vertical" class="d-flex align-center justify-space-between">
