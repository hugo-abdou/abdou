    ...
    <VContainer>
        <div class="misc-wrapper">
            <div class="text-center">
                ...
                <p>
                    We ran diagnosis on your server. Review the items that have a red mark on it. If everything is green, you are good to go
                    to the next step.
                </p>
            </div>
            <VList class="mb-3" lines="two">
                <VListSubheader inset> extensions </VListSubheader>

                <VListItem v-for="(value, extension, i) in extensions" :key="i" :title="extension">
                    <!--  :subtitle="folder.subtitle" -->
                    <template #prepend>
                        <VAvatar color="secondary" variant="tonal">
                            <VIcon :size="26" icon="tabler:puzzle" />
                        </VAvatar>
                    </template>
                ...
                <VListSubheader inset> directories </VListSubheader>

                <VListItem v-for="(value, directory, i) in directories" :key="i" :title="directory">
                    <template #prepend>
                        <VAvatar color="secondary" variant="tonal">
            ...
            <VBtn :disabled="!satisfied" to="/install/purchase_code" class="mt-12">Next Step >></VBtn>
